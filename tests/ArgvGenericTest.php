...
class ArgvGenericTest extends TestCase {
	...
	function testGetArgNames() {
		$generic = new ArgvGeneric();
		$generic->addNamedArg("input", new ArgGeneric());
		$generic->addNamedArg("output", new ArgGeneric());
	...
	function testGetNamedArg() {
		$generic = new ArgvGeneric();
		$generic->addNamedArg("input", new ArgGeneric());
		$this->assertInstanceOf("ArgGeneric", $generic->getNamedArg("input"));
	}
	...
	function testGetPositionalArgCount() {
		$generic = new ArgvGeneric();
		$generic->addPositionalArg("input", new ArgGeneric());
		$generic->addPositionalArg("output", new ArgGeneric());
	...
	function testGetPositionalArg() {
		...
		$generic->addPositionalArg("input", new ArgGeneric());
		$generic->addPositionalArg("output", new ArgGeneric());
		$this->assertInstanceOf("ArgGeneric", $generic->getPositionalArg(0));
	}
